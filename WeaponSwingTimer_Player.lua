...
function addon_data.player.RestoreDefaults()
    for setting, value in pairs(addon_data.player.default_settings) do
        character_player_settings[setting] = value
    end
...
--[[====================================== LOGIC RELATED =======================================]]--
--[[============================================================================================]]--
function addon_data.player.OnUpdate(elapsed)
...
function addon_data.player.ResetMainSwingTimer()
...
function addon_data.player.ZeroizeSwingTimers()
    addon_data.player.main_swing_timer = 0.0001
    addon_data.player.off_swing_timer = addon_data.player.off_weapon_speed * 0.6
end

function addon_data.player.UpdateMainSwingTimer(elapsed)
    if character_player_settings.enabled then
...
function addon_data.player.UpdateOffSwingTimer(elapsed)
    if character_player_settings.enabled then
        if addon_data.player.has_offhand then
...
--[[===================================== VISUALS RELATED ======================================]]--
--[[============================================================================================]]--
function addon_data.player.UpdateVisualsOnUpdate()
    ...
    if settings.enabled then
        ...
        then
            ...
            local castTime = C_Spell.GetSpellInfo(19750).castTime
...
function addon_data.player.UpdateVisualsOnSettingsChange()
    local frame = addon_data.player.frame
    local settings = character_player_settings
    if settings.enabled then
        frame:Show()
...
function addon_data.player.OnFrameDragStart()
    if not character_player_settings.is_locked then
        addon_data.player.frame:StartMoving()
    end
end

function addon_data.player.OnFrameDragStop()
    local frame = addon_data.player.frame
    local settings = character_player_settings
...
function addon_data.player.InitializeVisuals()
    local settings = character_player_settings
    -- Create the frame
...
function addon_data.player.UpdateConfigPanelValues()
...
function addon_data.player.EnabledCheckBoxOnClick(self)
    character_player_settings.enabled = self:GetChecked()
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.ShowOffHandCheckBoxOnClick(self)
    character_player_settings.show_offhand = self:GetChecked()
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.ShowBorderCheckBoxOnClick(self)
    character_player_settings.show_border = self:GetChecked()
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.ClassicBarsCheckBoxOnClick(self)
    character_player_settings.classic_bars = self:GetChecked()
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.FillEmptyCheckBoxOnClick(self)
    character_player_settings.fill_empty = self:GetChecked()
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.ShowLeftTextCheckBoxOnClick(self)
    character_player_settings.show_left_text = self:GetChecked()
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.ShowRightTextCheckBoxOnClick(self)
    character_player_settings.show_right_text = self:GetChecked()
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.ShowPaladinBloodCheckBoxOnClick(self)
    character_player_settings.pala_show_blood = self:GetChecked()
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.ShowPaladinCommandCheckBoxOnClick(self)
    character_player_settings.pala_show_command = self:GetChecked()
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.WidthEditBoxOnEnter(self)
    character_player_settings.width = tonumber(self:GetText())
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.HeightEditBoxOnEnter(self)
    character_player_settings.height = tonumber(self:GetText())
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.FontSizeEditBoxOnEnter(self)
    character_player_settings.fontsize = tonumber(self:GetText())
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.XOffsetEditBoxOnEnter(self)
    character_player_settings.x_offset = tonumber(self:GetText())
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.YOffsetEditBoxOnEnter(self)
    character_player_settings.y_offset = tonumber(self:GetText())
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.MainColorPickerOnClick()
    local colorTable = character_player_settings
    local r = "main_r"
    local g = "main_g"
    local b = "main_b"
    local a = "main_a"
...
function addon_data.player.MainTextColorPickerOnClick()
    local colorTable = character_player_settings
    local r = "main_text_r"
    local g = "main_text_g"
    local b = "main_text_b"
...
function addon_data.player.OffColorPickerOnClick()
    local colorTable = character_player_settings
    local r = "off_r"
    local g = "off_g"
    local b = "off_b"
...
function addon_data.player.OffTextColorPickerOnClick()
    local colorTable = character_player_settings
    local r = "off_text_r"
    local g = "off_text_g"
    local b = "off_text_b"
...
function addon_data.player.CombatAlphaOnValChange(self)
    character_player_settings.in_combat_alpha = tonumber(self:GetValue())
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.OOCAlphaOnValChange(self)
    character_player_settings.ooc_alpha = tonumber(self:GetValue())
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.BackplaneAlphaOnValChange(self)
    character_player_settings.backplane_alpha = tonumber(self:GetValue())
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.PaladinOffsetOnValChange(self)
    character_player_settings.pala_offset = tonumber(self:GetValue())
    addon_data.player.UpdateVisualsOnSettingsChange()
end

function addon_data.player.CreateConfigPanel(parent_panel)
